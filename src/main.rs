...
fn main() {
    //start by building the command prefixes for ycash-cli
    println!();
    println!("\x1b[48;5;58m\x1b[38;5;187mEnter path to ycash.conf\x1b[0m");
    println!("\x1b[48;5;54m\x1b[38;5;187m--example /home/ferris/.ycash/ycash.conf\x1b[0m");
    ...
    //get path to the ycash/src folder
    println!();
    println!("\x1b[48;5;58m\x1b[38;5;187mEnter path to ycash/src\x1b[0m");
    println!("\x1b[48;5;54m\x1b[38;5;187m--example   /home/ferris/ycash/src\x1b[0m");
    println!("\x1b[48;5;52m\x1b[38;5;187mInputting an invalid path is not recoverable!\x1b[0m");
    ...
    println!();
    println!("\x1b[48;5;58m\x1b[38;5;187mEnter path to .ycash/debug.log \x1b[0m");
    println!("\x1b[48;5;54m\x1b[38;5;187m--example   /home/ferris/.ycash/debug.log\x1b[0m");
    println!("\x1b[48;5;52m\x1b[38;5;187mInputting an invalid path is not recoverable!\x1b[0m");
    ...
    //first part
    let resend = String::from("./ycash-cli -conf=");
    //second part
    ...
    let s6 = String::from("> ~/ycash/src/climateuse0.txt 2>&1");
    let s7 = String::from("> ~/ycash/src/climateuse1.txt 2>&1");
    let s8 = String::from("> ~/ycash/src/climateuse2.txt 2>&1");
            ...
            "B" => {
				...
				let mut goodaddy = goodaddy1.replace('"', "");
						     ...
						     if kvc.contains("error") {
                                ...
                                //default?
                                //should resemble'
                                //ycash-cli z_sendmany “t1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd” ‘[{“address”: “ztfaW34Gj9FrnGUEf833ywDVL62NWXBM81u6EQnM6VR45eYnXhwztecW1SjxA7JrmAXKJhxhj3vDNEpVCQoSvVoSpmbhtjf”, “amount”: 5.0}]’ 10 0.00001 “AllowRevealedSenders”
